    ...
    <div style={{ fontFamily: "Arial, sans-serif", backgroundColor: "#f8f9fa" }}>
      ...
      <section style={{ padding: "20px", backgroundColor: "#e9ecef" }}>
        ...
        <p style={{ maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
          Welcome to Fresh Hotel Booking, your number one source for finding the best hotels at the most affordable prices. We're dedicated to providing you the very best of hospitality services, with an emphasis on luxury, comfort, and excellent customer service.
        </p>
      </section>
