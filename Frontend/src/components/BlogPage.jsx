  ...
  const posts = [
    {
      ...
      image: "https://blogcontent.yola.com/uploads/2015/01/image-for-blog-post-3.jpg",
    },
    {
      ...
      author: "Jane Smith",
      description:
        "As 2025 approaches, many small and medium-sized businesses (SMBs) are setting resolutions for growth and success in the coming year. One resolution that should top your list is building a professional, user-friendly website that enhances your online presence and attracts customers. With over 1 billion websites on the internet.",
    ...
    },
    {
      ...
      description:
        "As e-commerce continues to evolve, Yola’s Online Store is introducing new tools and features to empower small and medium-sized businesses. These updates are designed to enhance flexibility, transparency, and usability, making it easier for merchants to optimize their stores and meet customer needs. Here’s a detailed look.",
      image:
        "https://blogcontent.yola.com/uploads/2024/11/nick-morrison-FHnnjk1Yj7Y-unsplash-1.jpg",
    },
    {
